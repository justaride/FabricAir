...
## 1. Contact Verification Results

### Verified Contacts

| Organization | Contact | Role | Email | Status |
|--------------|---------|------|-------|--------|
| Orion | Carolina Sved | Head of Indirect & Sustainable Procurement | carolina.sved@orion.fi | ✅ VERIFIED |
| Valio | Hanna Hiekkamies | SVP Group Sustainability | hanna.hiekkamies@valio.fi | ✅ VERIFIED |
| KONE | Hanna Uusitalo | VP Environment & Sustainability | hanna.uusitalo@kone.com | ✅ VERIFIED |

### Contact Level Assessment

**Important Finding:** All three verified contacts are at **strategic/executive level**, not operational level. These are sustainability directors, NOT the people who manage day-to-day textile waste disposal.

| Contact | Level | Appropriate For |
|---------|-------|-----------------|
| Carolina Sved | Strategic | Partnership discussions, policy |
| Hanna Hiekkamies | Strategic | ESG initiatives, strategic sourcing |
| Hanna Uusitalo | Strategic | Environmental strategy |

**Gap Remains:** We still need operational contacts (facilities managers, waste coordinators) for actual textile disposal decisions.

---

## 2. Operational Contacts Discovered
...
Rester is participating in **PESCO-UP** EU Horizon project with 19 other organizations, focusing on transforming mixed polyester/cotton waste into high-quality materials. This may expand their capabilities for handling blends.

---

## 4. Material Composition Findings

### Critical Finding: Lindström Material

**Lindström workwear uses 65:35 poly-cotton blends — NOT 100% polyester.**

This finding was confirmed through web research. The implication is significant:

| Previous Assumption | Reality |
|---------------------|---------|
| Lindström provides 400 t/year of recyclable material | Material is 65:35 blend, NOT suitable for FabricAir |
| Lindström is a priority volume source | Must be reclassified as incompatible feedstock |

### Cleanroom Garment Specifications

| Provider | Material | Notes |
|----------|----------|-------|
| Standard cleanroom | 99% polyester + 1-6% polyester/carbon | Carbon for ESD protection |
| Lindström cleanroom | Meets EN-14065, ISO 14644 | Pharmaceutical grade |
| Elis cleanroom | Sterile garments | Operates in Finland |

**Implication:** Cleanroom garments typically contain 1-6% carbon fiber for anti-static properties. Need to verify if this is compatible with FabricAir's requirements.

### Touchpoint ReTouch Fabric

Touchpoint's circular fabric **ReTouch** contains recycled cotton/polyester — it is a blend, not 100% polyester. However, Touchpoint manages workwear from multiple sectors, some of which may be 100% PET.
...
| Factor | Finding |
|--------|---------|
| Source material | Cutting waste from India |
| Why not Finland? | "If we wanted to manufacture fabrics in Finland, we would have to use used clothes as raw material. However, that is not yet possible in terms of quality" — Anders Bengs, Founder |
| Competing for Finnish feedstock? | **NO** — They source from India |

**Strategic Implication:** Pure Waste is NOT competing for Finnish post-consumer polyester. They use pre-consumer cutting waste from Indian factories.

### Other Potential Competitors

| Company | Focus | Threat Level |
|---------|-------|--------------|
| Reima | Consumer recycled polyester | Low (different market) |
| Marimekko | Design focus, Rester customer | Low (not feedstock competitor) |
...
## 7. Updated Top 10 Assessment

### Ranking Adjustments Needed
...
| 5 | Image Wear | Manufacturer | ⚠️ Transitioning to recycled, verify specs |
| 6 | SOL Group | Aggregator | ◯ Unverified material composition |
| 7 | Orion | Pharma/cleanroom | ✅ Contact verified |
| 8 | Valio | Food processing | ✅ Contact verified |
| 9 | LSJH | Sorting | ✅ Confirmed sorting only |
| 10 | KONE | Industrial | ✅ Contact verified |

### Recommended New Ranking

| New Rank | Organization | Why |
|----------|--------------|-----|
| 1 | **Rester** | Only recycler — engage despite capacity concerns |
| 2 | **Puro** | Best source of white healthcare polyester |
| 3 | **Touchpoint** | Rester owner, diverse workwear access |
| 4 | **Orion** | Pharma cleanroom — 100% white polyester |
| 5 | **Image Wear** | Take-back program, verify specs |
| 6 | **Valio** | Food processing — verify material |
| 7 | **SOL Group** | Alternative aggregator |
| 8 | **KONE** | Industrial workwear — verify material |
| 9 | **Lindström** | ⬇️ Downgraded — 65:35 blend incompatible |
| 10 | **LSJH** | Coordination/sorting only |

---

## 8. Key Questions for FabricAir First Meeting

### Questions for Rester

1. "What volume of **100% white polyester** do you currently process?"
2. "What is your available capacity not committed to existing partners?"
3. "What feedstock sources provide the **highest quality 100% PET**?"
4. "Can you provide fiber specifications and samples?"
5. "Is cleanroom polyester with 1-6% carbon fiber acceptable in your process?"

### Questions for Puro

1. "What percentage of your healthcare textiles are **100% polyester**?"
2. "What is your annual volume of **white** polyester garments?"
3. "How do you currently dispose of end-of-life textiles?"
4. "Would you be interested in a direct partnership for textile recycling?"

### Questions for Orion

1. "Who manages your cleanroom garment disposal?"
2. "What is your annual volume of end-of-life cleanroom garments?"
3. "What is the material composition (including ESD carbon fiber)?"
4. "Can we connect with your facilities management team?"
...
| Gap | Priority | Effort to Close |
|-----|----------|-----------------|
| Operational waste contacts at Orion, Valio, KONE | High | Requires direct outreach |
| Rester available capacity (not committed) | High | Requires direct conversation |
| 100% polyester products from Image Wear, SOL | Medium | Catalog review or inquiry |
| Cleanroom carbon fiber compatibility | Medium | Technical inquiry |
| Updated disposal data (SYKE 2021 is 4 years old) | Low | Government inquiry |

### What This Research Cannot Resolve

These require **direct industry engagement**, not desk research:

1. Specific 100% PET product SKUs from manufacturers
2. Operational contacts at end-user organizations
3. Rester's actual uncommitted capacity
4. Pricing and volume commitments
5. Sample requests and quality verification
